...
class User {
    ...
    // setters
    set modificarNome(setNome) {
        this.nome = setNome;
    }
    set modificarSenha(setSenha) {
        this.senha = setSenha;
    }
    get verProjetosAlocado() {
...
class Projeto {
    constructor(nome, gerenteResponsavel, etapasDesenvolvimento, etapasConcepcao, etapasIdVisual) {
        this.nome = nome;
        this.gerenteResponsavel = gerenteResponsavel;
        this.etapasDesenvolvimento = etapasDesenvolvimento;
        this.etapasConcepcao = etapasConcepcao;
        this.etapasIdVisual = etapasIdVisual;
        Projeto.numProjetos++;
        this.id = Projeto.numProjetos;
        this.dataCriacao = new Date().toLocaleString("pt-br", { timeZone: "America/Sao_Paulo" });
    }
}
Projeto.numProjetos = 0;
class Sistema {
    static mostrarMenu() {
    ...
    static avancarProjetoConsultor(index) {
        console.clear();
    ...
    static avancarProjetoGerente(index) {
        console.clear();
    ...
    static modificarConsultorDados(index) {
        console.clear();
    ...
    static modificarGerenteDados(index) {
        console.clear();
        console.log("Modificando seus dados...");
        console.log("(Digite a letra \"m\" para voltar ao menu)");
        console.log("Nome do gerente: ");
    ...
    static listarProjetosAlocadoConsultor(index) {
        console.clear();
    ...
    static listarProjetosAlocadoGerente(index) {
        console.clear();
        console.log("Projetos alocado: ");
        console.log("(Digite a letra \"m\" para voltar ao menu)");
    ...
    static gerenteLoggedMenu(index) {
        let ligado = true;
        while (ligado) {
            console.clear();
    ...
    static consultorLoggedMenu(index) {
        let ligado = true;
        while (ligado) {
            console.clear();
...
Sistema.CONSULTORES = [];
Sistema.PROJETOS = [];
Sistema.PEDIDOS_AVANCO = [];
Sistema.PEDIDOS_RETIRADA = [];
Sistema.PROJETOS_CONCLUIDOS = [];
Sistema.iniciar();
